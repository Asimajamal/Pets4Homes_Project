                    ...
                    <div class="row">
                        <div class="col-2">
                            ...
                            <div class="d-flex flex-column article_icons">
                                <a>Share:</a>
                                <a href="" class="custom_btn text-white py-2 rounded text-decoration-none mt-1"><i class="fa-brands fa-facebook"></i></a>
                                <a href="" class="custom_btn text-white py-2 rounded text-decoration-none mt-2"><i class="fa-brands fa-twitter "></i></a>
                        ...
                        <div class="col-10">
                            ...
                            <div class="article_tags mb-3 my-3 ">
                                <span class="text-uppercase rounded-pill">Dogs</span> <span class="text-uppercase rounded-pill">life
                                    as a
                                    parent</span>
